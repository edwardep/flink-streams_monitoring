...
public class WorldCupSource2 implements SourceFunction<InputRecord> {
    ...
    public WorldCupSource2(String input_path) {
        ...
        while(isRunning) {
            ...
            if (reader.ready()) {
                ...
                InputRecord event = new InputRecord(
                        ...
                        Double.parseDouble(tokens[WCStruct.value.ordinal()]));
