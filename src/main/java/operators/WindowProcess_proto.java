...
public class WindowProcess_proto<VectorType> extends KeyedProcessFunction<String, InternalStream, InternalStream> {

    private int window_size;
    private int window_slide;
    private BaseConfig<VectorType, ?> cfg;

    public WindowProcess_proto(int window_size, int window_slide, BaseConfig<VectorType, ?> cfg) {
